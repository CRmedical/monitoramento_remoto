...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "dashboard.context_processors.hospital_groups",
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    'icons': {
        ...
        'dashboard.HospitalGroup': 'fa-solid fa-object-group',
        'dashboard.TelemetryHistory': 'fa-solid fa-scroll',
        'dashboard.MonthlyConsumption': 'fa-solid fa-calendar-days',
